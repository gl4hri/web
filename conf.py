...
BLOG_AUTHOR = "gl4hri"  # (translatable)
BLOG_TITLE = "Geometric Learning for HRI"  # (translatable)
SITE_URL = "https://gl4hri.org/"
# BASE_URL = "https://gl4hri.org/"
BLOG_EMAIL = "ljmanso@ljmanso.com"
BLOG_DESCRIPTION = "Geometric Learning for HRI"  # (translatable)
DEFAULT_LANG = "en"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (
          (
            ('/pages/sngnn-0D-v1', 'SNGNN 0D v1'),
            ('/pages/sngnn-0D-v2', 'SNGNN 0D v2'),
            ('/pages/sngnn-2D-v1', 'SNGNN 2D v1'),
          ), "Social Navigation Models"
        ),
        (
          (
            ('/pages/socnav1', 'SocNav1'),
            ('/pages/socnav2', 'SocNav2'),
            ('/pages/sonata', 'SONATA'),
          ), "Datasets & Tools",
        ),
        ("/pages/demos", "Demos"),
...
HIDDEN_AUTHORS = ['Guest', 'Luis J. Manso']
